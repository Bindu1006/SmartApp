...
import com.spectrum.smartapp.LightsListAdapter;
...
public class ViewDeviceAlarm extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onStart() {
        ...
        ArrayList<DeviceAlarmDetails> deviceAlarmList = databaseHelper.viewDeviceAlarm(ipAddress);
...
//        }
        ...
        if (id == R.id.action_settings) {
            ...
            Intent intent = new Intent(ViewDeviceAlarm.this, LoginActivity.class);
            startActivity(intent);
        }  else if (id == R.id.action_profile) {
            Intent intent = new Intent(ViewDeviceAlarm.this, EditProfileActivity.class);
            startActivity(intent);
        }
