...
public class CloudManagerAPI {
    ...
    public JSONObject generateWTCFile(final String tcName) throws IOException, JSONException, APIException {
        final JSONObject tcJSONObject = new JSONObject();
        tcJSONObject.put("name", tcName);
        final String response = sendRequest(Method.POST, PATH_ADD_TC+"/:"+PLACEHOLDER_TARGET_ID+"/generation/wtc", tcJSONObject);
